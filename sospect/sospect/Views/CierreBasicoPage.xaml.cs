...
namespace sospect.Views
{
    ...
    public partial class CierreBasicoPage : ContentPage
    {
        private CierreBasicoViewModel _viewModel;
        private bool _isSelectorOpen = false;

        public CierreBasicoPage(AlarmaCercana alarmaCercana)
        {
            InitializeComponent();
            _viewModel = new CierreBasicoViewModel(alarmaCercana);
        ...
        private async void OnCameraButtonTapped(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result == ThreeOptionResult.Option1)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("CierreBasicoPage: Abriendo CameraPopup para foto");

                    var cameraPopup = new CameraPopup();

                    cameraPopup.PhotoCaptured += async (s, photoPath) =>
                    {
                        System.Diagnostics.Debug.WriteLine($"CierreBasicoPage: Foto capturada: {photoPath}");
                ...
                else if (result == ThreeOptionResult.Option2)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("CierreBasicoPage: iOS - usando MediaPicker.CaptureVideoAsync para video");
                    ...
                    if (videoResult != null)
                    {
                        ...
                        await ModernAlerts.ShowProcessingAsync(processingText, async () =>
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"CierreBasicoPage: Video iOS copiado a caché: {videoPath}");
                    ...
                    System.Diagnostics.Debug.WriteLine("CierreBasicoPage: Abriendo VideoCameraPopup para video");

                    var videoCameraPopup = new VideoCameraPopup();

                    videoCameraPopup.VideoCaptured += async (s, videoPath) =>
                    {
                        System.Diagnostics.Debug.WriteLine($"CierreBasicoPage: Video capturado: {videoPath}");
                ...
                else if (result == ThreeOptionResult.Option3)
                {
                    ...
                    if (photo != null)
                    {
                        ...
                        await ModernAlerts.ShowProcessingAsync(processingText, async () =>
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"CierreBasicoPage: Foto galería copiada a caché: {cachedPath}");
            ...
            {
                CrashlyticsHelper.LogError(ex, "CierreBasicoPage", "OnCameraButtonTapped");
                System.Diagnostics.Debug.WriteLine($"CierreBasicoPage OnCameraButtonTapped ERROR: {ex.Message}");
            }
            finally
            {
